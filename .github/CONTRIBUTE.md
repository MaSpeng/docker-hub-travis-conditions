...
```bash
$ git clone git@github.com:maspeng/docker-hub-travis-conditions.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/maspeng/docker-hub-travis-conditions.git
```
...
2. Fork the repository (http://github.com/maspeng/docker-hub-travis-conditions)
3. Clone the canonical repository locally and enter it.

```bash
$ git clone git://github.com/maspeng/docker-hub-travis-conditions.git
$ cd docker-hub-travis-conditions
```

4. Add a remote to your fork; substitute your GitHub username in the command below.

```bash
$ git remote add {username} git@github.com:{username}/docker-hub-travis-conditions.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-travis-conditions.git
